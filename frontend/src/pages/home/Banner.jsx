    ...
    <section className="flex flex-col md:flex-row-reverse py-16 items-center justify-center gap-12">
      ...
      <div className="md:w-1/2 w-full">
        ...
        <p className="mb-10">
          ...
          reflecting the desire for something less destructive amid chaos. Here's
          some text exploring this concept: I want a better catastrophe.
        </p>
        <div className="flex flex-col items-center mt-8">
          ...
          >
            ...
            <input
              ...
              className="bg-white border border-gray-300 rounded-md shadow-sm py-3 px-4 w-full md:flex-grow focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary mb-4 md:mb-0"
            />
            <button
              type="submit"
